...
<body>
    <div class="container">
        ...
        <form action="upload-vul.php" method="post" enctype="multipart/form-data">
        ...
        <hr>
        <p>Esse laboratório é vulnerável a uma vulnerabilidade de inclusão de arquivos. Seu objetivo é demonstrar como fazer a execução remota de código e a exposição de arquivos confidenciais.</p>
